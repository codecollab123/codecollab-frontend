      ...
      <CardContent className="p-5">
        ...
        <div className="border rounded-md overflow-hidden">
          <img
            ...
            src="https://www.simplilearn.com/ice9/free_resources_article_thumb/Trees-Soni/sibling-of-tree-data-structure1.png"
            alt="Post"
          />
        </div>
        {/* caption */}
        <div className="mt-4">
          ...
          <p className=" text-gray-500">
            A quick guide to mastering fundamental data structures for efficient
            problem-solving. Learn about arrays, linked lists, trees, and
            graphs.
          </p>
        </div>

        <span className="text-sm text-gray-500 mt-3 block">5 comments</span>
        ...
        <div className="flex items-center gap-2 mt-3 border-t pt-3">
          ...
          <Button
            variant="outline"
            className="px-4 py-1 text-blue-600 border-blue-500"
          >
            Post
          </Button>
        </div>
