...
const HomePage = () => {
  ...
  const filters = [
    ...
    { id: "questions", label: "Questions", count: mockPosts.filter(p => p.type === "question").length },
    { id: "solutions", label: "Solutions", count: mockPosts.filter(p => p.type === "solution").length },
    { id: "challenges", label: "Challenges", count: mockPosts.filter(p => p.type === "challenge").length }
  ];
  ...
  const filteredPosts = activeFilter === "all"
    ...
    : mockPosts.filter(post =>
        ...
        activeFilter === "solutions" ? post.type === "solution" :
        activeFilter === "challenges" ? post.type === "challenge" : true
      );
        ...
        <div className="max-w-6xl mx-auto px-4">
          <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
              ...
              <div className="sticky top-20 space-y-6">
                ...
                <div className="bg-card rounded-lg p-4 shadow-sm border border-border">
                  ...
                  <div className="flex flex-wrap gap-2">
                    {["binary-search", "dynamic-programming", "graphs", "trees", "sorting"].map((topic) => (
                      <Badge
                        key={topic}
                        variant="outline"
            ...
            <div className="lg:col-span-2">
              <div className="mb-6">
                <h2 className="text-2xl font-bold text-foreground mb-2">Your Feed</h2>
            ...
            <div className="lg:col-span-1">
              <div className="sticky top-20 space-y-6">
                ...
                {/* Active Challenges */}
                <div className="bg-card rounded-lg p-4 shadow-sm border border-border">
                  <h3 className="font-semibold text-foreground mb-4">Active Challenges</h3>
                  <div className="space-y-3">
                    <div className="p-3 bg-purple-100 dark:bg-purple-900/30 rounded-lg">
                      <p className="text-sm font-medium text-purple-800 dark:text-purple-300">Weekly Contest #45</p>
                      <p className="text-xs text-purple-600 dark:text-purple-400">Ends in 2 days</p>
                    </div>
                    <div className="p-3 bg-green-100 dark:bg-green-900/30 rounded-lg">
                      <p className="text-sm font-medium text-green-800 dark:text-green-300">Graph Algorithms</p>
                      <p className="text-xs text-green-600 dark:text-green-400">5/10 completed</p>
                    </div>
                  </div>
                </div>
