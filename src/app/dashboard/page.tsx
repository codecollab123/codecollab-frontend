...
<div
  className="relative w-full h-40 rounded-2xl overflow-hidden shadow-lg border border-white/10 mb-10 max-w-6xl mx-auto"
>
  {/* Background image */}
  <div
  ...
  <div className="relative z-10 flex items-center justify-between h-full px-6">
    ...
    <div className="flex flex-col">
      ...
      <p className="text-gray-200/90 text-sm mt-1 max-w-md">
        <b>100% focus?</b> Set the scene with atmospheric backgrounds, use timer
        and goal setting — and study in your solo study room.
      </p>
            ...
            <Card className="bg-[#161616] border border-white/10 rounded-2xl shadow-xl">
              <CardContent className="p-6 flex items-center space-x-4">
                ...
                <div>
                  ...
                  <p className="text-green-500 text-sm">Question, Solution or Challenge</p>
                </div>
              </CardContent>
            </Card>
          </motion.div>
            ...
            <Card className="bg-[#161616] border border-white/10 rounded-2xl shadow-xl">
              <CardContent className="p-6 flex items-center space-x-4">
                ...
                <div>
                  ...
                  <p className="text-green-500 text-sm">Collaborative coding rooms</p>
                </div>
              </CardContent>
            </Card>
          </motion.div>
            ...
            <Card className="bg-[#161616] border border-white/10 rounded-2xl shadow-xl">
              <CardContent className="p-6 flex items-center space-x-4">
                ...
                <div>
                  ...
                  <p className="text-green-500 text-sm">Save and access your notes</p>
                </div>
              </CardContent>
            </Card>
          </motion.div>
            ...
            <Card className="bg-[#161616] border border-white/10 rounded-2xl shadow-xl">
              <CardContent className="p-6 flex items-center space-x-4">
                ...
                <div>
                  ...
                  <p className="text-green-500 text-sm">Talk with your study buddies</p>
                </div>
              </CardContent>
            </Card>
          </motion.div>
