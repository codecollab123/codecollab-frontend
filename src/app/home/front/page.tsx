    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950 text-white overflow-x-hidden">
      ...
      <section id="home" className="relative pt-24 pb-16 px-4 sm:px-6 min-h-screen flex items-center overflow-hidden">
        ...
        <div className="absolute inset-0">
          ...
          <div className="absolute top-40 right-20 w-24 h-24 border border-purple-500/20 rounded-lg"
        ...
        <div className="container mx-auto text-center relative z-10">
          <div className="max-w-5xl mx-auto">
            ...
            <h1 className={`text-4xl sm:text-6xl md:text-8xl font-bold mb-8 bg-gradient-to-r from-cyan-400 via-blue-400 to-cyan-400 bg-clip-text text-white leading-tight ${isVisible ? 'animate-fade-in' : 'opacity-0'}`}
            ...
            <div className={`flex flex-col sm:flex-row gap-6 justify-center items-center mb-16 ${isVisible ? 'animate-fade-in' : 'opacity-0'}`}
              ...
              {/* <Button size="lg" variant="outline" className="border-2 border-cyan-400/50 text-cyan-400 hover:bg-cyan-400/10 hover:border-cyan-400 px-8 py-4 text-lg transition-all duration-300 hover:scale-105 shadow-xl hover:shadow-cyan-400/25 backdrop-blur-sm group bg-slate-900/30"> */}
               <Button size="lg" className="bg-gradient-to-r from-cyan-500 to-red-500 hover:from-cyan-600 hover:to-blue-600 text-white font-semibold px-8 py-4 text-lg transition-all duration-300 hover:scale-105 shadow-xl group">
            ...
            <div className={`grid grid-cols-2 md:grid-cols-4 gap-8 ${isVisible ? 'animate-fade-in' : 'opacity-0'}`}
                 style={{ animationDelay: '0.6s', transform: `translateY(${scrollY * -0.03}px)` }}>
      ...
      <section id="features" className="relative py-24 px-4 sm:px-6 bg-gradient-to-b from-slate-900/50 to-slate-950 overflow-hidden">
        {/* Parallax background elements */}
        <div className="absolute inset-0">
          <div className="absolute top-20 left-0 w-72 h-72 bg-gradient-to-r from-cyan-500/5 to-blue-500/5 rounded-full blur-3xl"
               style={{ transform: `translateY(${scrollY * 0.1}px)` }} />
          <div className="absolute bottom-20 right-0 w-96 h-96 bg-gradient-to-r from-purple-500/5 to-pink-500/5 rounded-full blur-3xl"
      ...
      <section className="relative py-24 px-4 sm:px-6 bg-gradient-to-b from-slate-950 to-slate-900/50 overflow-hidden">
        {/* Parallax background */}
        <div className="absolute inset-0">
          <div className="absolute top-0 left-1/4 w-64 h-64 bg-gradient-to-r from-cyan-500/10 to-blue-500/10 rounded-full blur-3xl"
        ...
        <div className="container mx-auto relative z-10">
          ...
          <div className="grid md:grid-cols-3 gap-8"
            ...
            {testimonials.map((testimonial, index) => (
              <Card key={index} className="bg-slate-800/50 border-slate-700/50 backdrop-blur-sm hover:border-cyan-500/50 transition-all duration-300 group">
      ...
      <section id="about" className="relative py-24 px-4 sm:px-6 bg-gradient-to-b from-slate-900/50 to-slate-950 overflow-hidden">
        {/* Parallax background */}
        <div className="absolute inset-0">
          <div className="absolute top-1/2 right-0 w-80 h-80 bg-gradient-to-r from-cyan-500/5 to-blue-500/5 rounded-full blur-3xl"
      ...
      <section className="relative py-24 px-4 sm:px-6 bg-slate-900 overflow-hidden">
        ...
        <div className="absolute inset-0">
          <div className="absolute top-10 left-10 w-24 h-24 border border-cyan-500/20 rounded-full"
               style={{ transform: `translateY(${scrollY * 0.1}px) rotate(${scrollY * 0.05}deg)` }} />
          <div className="absolute bottom-10 right-10 w-32 h-32 border border-blue-500/20 rounded-lg"
      ...
      <footer className="bg-slate-950 border-t border-slate-800/50 py-16 px-4 sm:px-6 relative overflow-hidden">
        ...
        <div className="absolute inset-0">
          <div className="absolute bottom-0 left-0 w-64 h-64 bg-gradient-to-t from-cyan-900/10 to-transparent rounded-full blur-3xl"
               style={{ transform: `translateY(${scrollY * 0.05}px)` }} />
        </div>
